...
def record_audio():
    commands = [
        ['arecord', '-D', 'hw:0,2', '-f', 'S16_LE', '-r', '16000', '-c', '1', '-d', '6', WAV_FILE_PATH],
        ['arecord', '-D', 'hw:0,0', '-f', 'S16_LE', '-r', '16000', '-c', '1', '-d', '6', WAV_FILE_PATH],
        ['arecord', '-D', 'hw:2,0', '-f', 'S16_LE', '-r', '16000', '-c', '1', '-d', '6', WAV_FILE_PATH],
        ['arecord', '-D', 'hw:2,2', '-f', 'S16_LE', '-r', '16000', '-c', '1', '-d', '6', WAV_FILE_PATH]
    ]
